...
void MainWindow::init()
{
    ...
    connect(ui->win64_props_action, &QAction::triggered, this, [=]() {
        ...
        if (!p.is_load())
        {
            QMessageBox::StandardButton btn = QMessageBox::warning(
                this, "import props", "全局属性表路径不存在，是否创建",
            ...
            p.save();
            QMessageBox::about(this, "import props",
                               "已为您创建 x64 全局属性表");
        }
        // p.print_content();
    ...
    connect(ui->project_props_action, &QAction::triggered, this, [=]() {
        ...
        if (!filepath.isEmpty())
        {
            ...
            {
                QMessageBox::warning(this, "open props/project",
                                     "未知的文件格式！");
                return;
            }
    ...
    /* new props editor */
    connect(ui->new_props_action, &QAction::triggered, this,
            &MainWindow::new_attribute_table_wdiget);
    ...
    /* new props editor */
    connect(this, &MainWindow::add_props_editor, this,
            [=](attribute_table_widget *w, const props &p) {
    ...
    /* close current props editor */
    connect(this, &MainWindow::remove_props_editor, this,
            [=](attribute_table_widget *w) {
                int index = ui->props_editors->indexOf(w);
                if (index != -1)
                {
    ...
    connect(ui->remove_sub_props_action, &QAction::triggered, this, [=]() {
        ...
        if (n >= 1)
        {
            ...
            QString sub_props_file = QInputDialog::getItem(
                this, "remove sub props", "请选择要删除的子属性表:", sub_props,
                0, false, &ok);
    ...
    connect(ui->cover_props_action, &QAction::triggered, this, [=]() {
        ...
        if (n >= 1)
        {
            ...
            const QString &filepath = QFileDialog::getOpenFileName(
                this,
                QStringLiteral("select props file to cover current props"), "",
                QStringLiteral("props file(*.props)"));
            ...
            if (!filepath.isEmpty())
            {
                ...
                {
                    QMessageBox::warning(this, "cover current props",
                                         "选择的属性表格式异常，终止操作");
                    return;
                }
    ...
    connect(ui->links_action, &QAction::triggered, this, [=]() {
        ...
        QString str =
            "CGAl、Boost、PCL 下载链接参考：\n"
            "1. CGAL gmp : "
            "https://github.com/CGAL/cgal/releases/download/v6.1/"
            "CGAL-6.1-win64-auxiliary-libraries-gmp-mpfr.zip\n"
            "2. CGAL source : "
            "https://github.com/CGAL/cgal/releases/download/v6.1/CGAL-6.1.zip\n"
            "3. Boost : "
            "https://archives.boost.io/release/1.89.0/binaries/"
            "boost_1_89_0-msvc-14.3-64.exe\n"
            "4. PCL : "
            "https://github.com/PointCloudLibrary/pcl/releases/download/"
            "pcl-1.15.1/"
            "PCL-1.15.1-AllInOne-msvc2022-win64.exe\n"
            "\nGithub 文件加速下载镜像：\n"
            "https://gh-proxy.com/\n"
    ...
    connect(
        ui->custom_library_cmake_template_action, &QAction::triggered, this,
        [=]() {
            QMessageBox box(this);
            box.setTextInteractionFlags(Qt::TextSelectableByMouse);
            QString str =
